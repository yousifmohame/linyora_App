...
class ModelBankSettingsScreen extends StatefulWidget {
  const ModelBankSettingsScreen({Key? key}) : super(key: key);

  @override
  State<ModelBankSettingsScreen> createState() =>
      _ModelBankSettingsScreenState();
}

class _ModelBankSettingsScreenState extends State<ModelBankSettingsScreen> {
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    _buildCard(
                      title: l10n.basicInfoTitle, // ✅ مترجم
